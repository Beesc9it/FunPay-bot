...
class Cardinal(object):
    ...
    def send_message(self, chat_id: int, message_text: str, chat_name: str | None,  attempts: int = 1) -> \
        ...
        for mes in submessages:
            ...
            while current_attempts:
                try:
                    ...
                    if msg:
                        logger.info(f"Отправил сообщение в чат $MAGENTA{chat_id}.")
                        break
                except:
                ...
                logger.info(f"Сообщение было отправлено в чат $MAGENTA{chat_id}$RESET: "
                             f"")
                return None
        return msg
